  ...
  return (
    <div className="h-full w-full p-16 relative">
      ...
      <div id="main-content" className="w-[60%] min-w-[24rem] flex flex-col gap-5 mt-16">
        ...
        <button className="w-[12rem] h-[3rem] rounded-xl bg-coda-blue-500 font-semibold mt-10 transition-all hover:bg-coda-blue-300">Try it out</button>
      </div>
      <Circle size={'8rem'} blurSize={"1.2rem"} top={"60vh"} right={"13vw"} invert={true}/>
      <Circle size={'21rem'} blurSize={"2.5rem"} top={"42vh"} right={"29vw"}/>
      <Circle size={'15rem'} blurSize={"2rem"} top={"7vh"} right={"8vw"} invert={true}/>
    </div>
  );
}
